  ...
  return (
    <div className="relative w-[90px]">
      ...
      >
        ...
        <div className="w-[190px] relative border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
          <input
            type="search"
            id="default-search"
            className="block w-[150px] p-2 ps-10 text-sm text-gray-900 border border-none rounded-l-lg"
        ...
        <form className="w-[60%] bg-white rounded-lg p-6">
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 overflow-hidden">
            <thead className="text-xs text-white uppercase bg-[#4856BEF5] dark:bg-gray-700 dark:text-gray-400">
              <tr>
                <th scope="col" className={`px-6 py-3 `}  style={{fontSize:"12px"}}>
                  Column Name
                </th>
                <th scope="col" className={`px-6 py-3 `}  style={{fontSize:"12px"}}>
                  Operator
                    ...
                    <td className={`w-[300px] flex-grow px-6 py-4 `} >
                      ...
                      >
                        ...
                        {operatorOptions.map((option) => (
                          <option key={option} value={option}  style={{fontSize:"12px"}}>
                            {option}
                          </option>
                        ))}
                      </select>
